// Script para verificar e corrigir organizações
const checkAndFixOrganizations = async () => {
  const supabaseUrl = 'https://bjsuujkbrhjhuyzydxbr.supabase.co';
  const functionUrl = `${supabaseUrl}/functions/v1/check-and-fix-organizations`;

  try {
    console.log('Verificando e corrigindo organizações...');
