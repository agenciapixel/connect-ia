...
serve(async (req) => {
  ...
  try {
    const { context, tone, objective } = await req.json();
    ...
    const systemPrompt = `Você é um especialista em copywriting e comunicação para marketing digital. 
Sua tarefa é gerar mensagens persuasivas e eficazes para campanhas de marketing.
Tom: ${tone || 'profissional e amigável'}
Objetivo: ${objective || 'engajar o público'}`;
    ...
    console.error("Error in ai-generate-message function:", error);
