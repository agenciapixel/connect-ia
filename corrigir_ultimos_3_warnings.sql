-- Script para corrigir os últimos 3 warnings de Function Search Path Mutable
-- Execute este script no Supabase Dashboard > SQL Editor

-- ========================================
-- CORRIGIR ÚLTIMOS 3 WARNINGS
-- ========================================

-- Corrigir insert_message
...
SELECT 
    ...
    'Function Search Path Mutable: 0/8' as warnings_corrigidos,
    'Extension in Public: 1/1 (manual)' as warning_manual_1,
    'Leaked Password Protection: 1/1 (manual)' as warning_manual_2;
